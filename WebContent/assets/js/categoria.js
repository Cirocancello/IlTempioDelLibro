 ...
 */function search(query) {
	let resultingHtml = ``;
	$.ajax({
		url: `/iltempiodeldigitale-website/search?query=${query}`,
		success: (data) => {
			...
			for (let i = 0; i < parseData.length; i++) {
				...
				<div class="card-img-container">
				  <a href="/iltempiodeldigitale-website/product?id=${element.idProdotto}">
					<img
				...
				<div class="card-image-container">
				  <a href="/iltempiodeldigitale-website/product?id=${element.idProdotto}"><img src="${element.imageUrl}" alt="" class="card-image"></a>
				</div>
				<div class="card-body">
				  <a class="h3-link-title" href="/iltempiodeldigitale-website/product?id=${element.idProdotto}">${element.nome}</a>
